...
// TEXT_INPUT_BASE 정의
export const TEXT_INPUT_BASE = `${COMMON_TEXT_STYLE} w-full border-b-[1px] pb-1 border-gray-300 placeholder:text-gray-400
   focus:outline-none 
   focus:border-b-[2x] focus:border-black`;

export const TEXT_AREA_BASE_STATIC = `${COMMON_TEXT_STYLE} w-full resize-none p-4 rounded-[30px] 
...
export const DROPDOWN_BASE_STATIC = `${COMMON_TEXT_STYLE} w-full px-4 py-3 rounded-[10px] bg-white appearance-none cursor-pointer
